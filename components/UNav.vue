<template>
  <div class="border-b border-gray-200">
    <div
      class="px-4 md:px-0 md:w-11/12 xl:w-10/12 mx-auto py-4 flex items-center justify-between"
    >
      <div class="flex items-center w-full lg:w-auto">
        ...
        <nav class="ml-2 xl:ml-4 lg:flex items-center hidden">
          <nuxt-link
            v-for="{ name, route } in navTabs"
            :key="name"
            :to="route"
            class="xl:ml-2"
          >
            <u-tab :text="name" :is-active="route === $route.path" />
          </nuxt-link>
        </nav>
      </div>

      <div class="hidden lg:flex items-center">
        <u-button variant="secondary" outlined>
          <template #icon>
            <svg
              width="18"
              height="20"
          ...
          <p class="font-medium">Upgrade now</p>
        </u-button>
        <div class="flex items-center mx-2 xl:mx-4">
          <div class="nav-icon">
            <svg
              width="20"
              height="20"
            ...
            >
              <path
                d="M10 12.5C11.3807 12.5 12.5 11.3807 12.5 9.99998C12.5 8.61927 11.3807 7.49998 10 7.49998C8.6193 7.49998 7.50001 8.61927 7.50001 9.99998C7.50001 11.3807 8.6193 12.5 10 12.5Z"
                stroke="#667085"
          ...
          <div class="nav-icon">
            ...
            >
              <path
                d="M10.4417 17.5C10.2952 17.7526 10.0849 17.9622 9.83185 18.108C9.57884 18.2537 9.29198 18.3304 9 18.3304C8.70802 18.3304 8.42116 18.2537 8.16814 18.108C7.91513 17.9622 7.70484 17.7526 7.55833 17.5M14 6.66669C14 5.3406 13.4732 4.06883 12.5355 3.13115C11.5979 2.19347 10.3261 1.66669 9 1.66669C7.67392 1.66669 6.40215 2.19347 5.46447 3.13115C4.52678 4.06883 4 5.3406 4 6.66669C4 12.5 1.5 14.1667 1.5 14.1667H16.5C16.5 14.1667 14 12.5 14 6.66669Z"
                stroke="#667085"
                stroke-width="1.66667"
                stroke-linecap="round"
                stroke-linejoin="round"
...
<script lang="ts">
import Vue from 'vue'
import ULogo from '~/assets/svg/ULogo.vue'
